#############################################################################
# Makefile for building: Modelisation
# Generated by qmake (3.1) (Qt 5.9.2)
# Project:  Modelisation.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile Modelisation.pro -spec linux-g++
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Modelisation1.0.0
DISTDIR = /home/etu/p1409693/workspace/GeoMod/.tmp/Modelisation1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: Modelisation.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Modelisation.pro -spec linux-g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents noisef.h vec.h heightField.h layerField.h scalarField.h box2.h array2.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp noisef.cpp vec.cpp heightField.cpp layerField.cpp scalarField.cpp box2.cpp array2.cpp $(DISTDIR)/
...
noisef.o: noisef.cpp noisef.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o noisef.o noisef.cpp

vec.o: vec.cpp vec.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o vec.o vec.cpp

heightField.o: heightField.cpp heightField.h \
		array2.h \
		box2.h \
		vec.h \
		image_io.h \
		image.h \
		color.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o heightField.o heightField.cpp

layerField.o: layerField.cpp layerField.h \
		heightField.h \
		array2.h \
		box2.h \
		vec.h \
		...
		image.h \
		color.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o layerField.o layerField.cpp

scalarField.o: scalarField.cpp scalarField.h \
		array2.h \
		box2.h \
		vec.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o scalarField.o scalarField.cpp

box2.o: box2.cpp box2.h \
		vec.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o box2.o box2.cpp

array2.o: array2.cpp array2.h \
		box2.h \
		vec.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o array2.o array2.cpp
